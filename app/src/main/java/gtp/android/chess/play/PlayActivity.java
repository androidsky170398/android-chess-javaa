package gtp.android.chess.play;
...
import gtp.android.chess.GamesListActivity;
import gtp.android.chess.helpers.MyPGNProvider;
import gtp.android.chess.R;
import gtp.android.chess.activities.ChessBoardActivity;
import gtp.android.chess.activities.GlobalPreferencesActivity;
import gtp.android.chess.constants.ColorSchemes;
import gtp.android.chess.constants.PieceSets;
import gtp.android.chess.engine.EngineApi;
import gtp.android.chess.engine.EngineListener;
import gtp.android.chess.engine.LocalEngine;
import gtp.android.chess.helpers.PGNHelper;
import gtp.android.chess.helpers.ResultDialogListener;
import gtp.android.chess.services.ClockListener;
import gtp.android.chess.services.EcoService;
import gtp.android.chess.services.GameApi;
import gtp.android.chess.services.LocalClockApi;
import gtp.android.chess.views.CapturedCountView;
import gtp.android.chess.views.ChessPieceView;
import gtp.android.chess.views.ChessPiecesStackView;
import gtp.chess.Move;
import gtp.chess.PGNColumns;
import gtp.chess.board.BoardConstants;
        ...
        switch (requestCode) {
            case REQUEST_MENU:
                ...
                if (item.equals(getString(R.string.menu_game_settings))) {
                    ...
                    intent = new Intent();
                    intent.setClass(PlayActivity.this, gtp.android.chess.setup.SetupActivity.class);
